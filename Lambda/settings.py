...
YA_REDIRECT_URL = "http://dc01837f.ngrok.io/yellowant-oauth-redirect/"

# Numerical ID generated when you register your application through the YA developer console
YA_APP_ID = os.environ.get("YA_APP_ID", 1847)
# Client ID generated from the YA developer console. Required to identify
# requests from this application to YA
YA_CLIENT_ID = os.environ.get("YA_CLIENT_ID", "JTYB3oHCRLuLIG5RZSgHsYj071hfOUuH1QBP58BB")
# Client secret generated from the YA developer console. Required to identify requests
# from this application to YA
YA_CLIENT_SECRET = os.environ.get("YA_CLIENT_SECRET", "tc4ufZZgkjEhtRAqNQZmDxAauTZvBY1FyOA8b7HHVRy"
                                                      "vwhEnwgDgjDAURmMbPMqML5zSNRiYU2IBRXXyDyn9Rf"
                                                      "Kcpn7pnr1T54Bgtw7BJ8Jkz1poQSqsSpbJ1YGHFjk5")
...
YA_VERIFICATION_TOKEN = os.environ.get("YA_VERIFICATION_TOKEN", "XNuorOSIxSQHUuwrt2bPzNfiVXEXortp"
                                                                "SEH8oZ9IsdSMeCG6aYp3eHypXrNeGwEO"
                                                                "yuHoxtI4IFOZqbe795VVXPrBNudYNvOPl"
                                                                "1PS2rM7exGqDlwtvgcOb5xVy9uMzylV")
...
SECRET_KEY = 'e6wp^@rypa$h=c76i+@9l2rw3zfytr%o6##u+h57liaf4^u1y*'
